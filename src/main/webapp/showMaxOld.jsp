...
<%--                        Довольно заезженный сюжет. Фильм для просмотра один раз.--%>
<%--                    </div>--%>
<%--                </div>--%>
...
<%--                    <div class="review_text">--%>
<%--                        Фильм впечатлил. Очередная интересная работа Миллера.--%>
<%--                    </div>--%>
<%--                </div>--%>
