...
<div class="main">
    ...
    <div class="site_content">
        ...
        <div class="content">
            ...
            <input type="search" id="input" class="input search-form" placeholder="&#128269;Перейдите на страницу интересующего фильма" />
            <div class="search">
                <ul class="ul">
                    <li><a href="showMatrix.jsp">матрица</a></li>
                    <li><a href="showInterstellar.jsp">интерстеллар</a></li>
                    <li><a href="showCloud.jsp">облачный атлас</a></li>
                    <li><a href="showMax.jsp">безумный Макс</a></li>
                </ul>
            </div>
