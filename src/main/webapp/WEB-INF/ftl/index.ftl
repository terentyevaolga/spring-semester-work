...
<div class="form-style-5">
    ...
    <form class="signup-form" method="post" action="/signup">
        <input class="input input-field name" type="text" id="name" name="name" placeholder="Login">
        ...
        <lable><p>Длина пароля от 4 до 12 символов, обязательны одна заглавная буква и цифра</p>
            <input class="input input-field password" type="password" id="password" name="password" placeholder="Enter password">
        </lable>
        <input type="submit" value="SugnUp" class="btn">
    </form>
    <div class="button"><a href="signIn">SignIn</a></div>
</div>
